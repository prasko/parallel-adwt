function [thm, yhat, yd] = lsw(z, nn, N, th0);
%LSW    Computes windowed LS-estimates of ARX-models.
%   [THM,YHAT,YD] = LSW(Z,NN,N,th0)
%
...
%
%   See also LS, ARX, LAW_LP, LAW_IRWLS
%

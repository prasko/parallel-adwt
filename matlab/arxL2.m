function p = arxL2(z,orders,p,wphi)
%ARXL2    Computes least squared estimates of ARX-models (minimum L2 error)
%
%   P = ARXL2(DATA,ORDERS)
%
...
%
%   ARXL2(DATA,ORDERS,P0) uses initial value P0 of the model
%   parameters.
%
%   In ARXL2(DATA,ORDERS,P0,WPHI), WPHI determines which part of shifted data matrix 
%   is kept in calculation: 'f','c' and 'l' correspond to first, central and last part, 
%   'a' corresponds to the whole matrix. Default is 'l'.
%
% See also ARXL1LP, ARX.
%
%   D. Sersic and A. Sovic
%   Copyright 2010 FER-ZESOI
%   $Revision: 3.02.0.2 $  $Date: 2011/01/21 18:00:00 $
...
p=p';
p(1:na)=-p(1:na); % Reverse sign of output parameters
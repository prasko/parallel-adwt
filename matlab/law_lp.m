function [thm, yhat, yd] = law_lp(z, nn, N, th0);
%LAW_LP    Computes windowed least absolute estimates of ARX-models.
%   [THM,YHAT,YD] = LAW_LP(Z,NN,N,th0)
%
